...
export default function FileUpload({
  ...
  return (
    ...
    >
      <div className="group relative w-full rounded-xl bg-card ring-1 ring-border p-0.5">
        ...
        <div className="relative w-full rounded-[10px] bg-muted/50 p-1.5">
          <div
            className={cn(
              "relative mx-auto w-full overflow-hidden rounded-lg border border-border bg-card",
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-y-0 left-0 w-[20%] bg-gradient-to-r from-primary/10 to-transparent" />
              <div className="absolute inset-y-0 right-0 w-[20%] bg-gradient-to-l from-primary/10 to-transparent" />
                ...
                {status === "idle" || status === "dragging" ? (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-4/5 flex items-center justify-center gap-2 rounded-lg bg-secondary px-4 py-2.5 text-sm font-semibold text-secondary-foreground transition-all duration-200 hover:bg-secondary/80 group"
                    >
                  ...
                  >
                    ...
                    <button
                      onClick={resetState}
                      type="button"
                      className="w-4/5 flex items-center justify-center gap-2 rounded-lg bg-secondary px-4 py-2.5 text-sm font-semibold text-secondary-foreground transition-all duration-200 hover:bg-secondary/80"
                    >
                      Cancel
                    </button>
                  </motion.div>
            ...
            <AnimatePresence>
              {error && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  className="absolute bottom-4 left-1/2 transform -translate-x-1/2 px-4 py-2 bg-destructive/10 border border-destructive/20 rounded-lg"
                >
